        ...
        for(int i=0;i<v;i++)
        {
            for(int j=0;j<v;j++)
            {
                if (d[i][j]>0)
                {
                    ...
                    g.drawString(Integer.toString(d[i][j]),((int)c[i].x+(int)c[j].x+80)/2,((int)c[i].y+(int)c[j].y+80)/2);
                    int x0=(int)c[i].x+40;
                    int y0=(int)c[i].y+40;
                    int x1=(int)c[j].x+40;
                    int y1=(int)c[j].y+40;
        ...
        while (true) {
            ...
            if (xuanze == 1) {
                ...
                if (q.list.contains(shuru2[0]) && q.list.contains((shuru2[1]))) {
                    ...
                    if (q.count == 1) {
                        System.out.println("The bridge words from" + "\"" + shuru2[0] + "\"" + "to" + "\"" + shuru2[1] + "\"" + "is:" + ww[0] + "!");
                    }
                    if (q.count > 1) {
                        System.out.print("The bridge words from" + "\"" + shuru2[0] + "\"" + "to" + "\"" + shuru2[1] + "\"" + "is:");
                ...
                else
                {
                    if(q.list.contains(shuru2[0])==false && q.list.contains((shuru2[1]))==false) {
                        System.out.println("No" + "\"" + shuru2[0] + "\"" + "and" + "\"" + shuru2[1] + "\"" + "in the graph!");
                    }
